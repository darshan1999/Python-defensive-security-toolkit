"""
Threat Hunting Automation With Siem Python
...
if __name__ == "__main__":
    main()
# - Blocking vs. Non-Blocking: `exec_mode="blocking"` simplifies small searches; large
#   data sets require asynchronous polling.
# - Time Bounds: Always specify `earliest_time`/`latest_time` to avoid re-scanning
#   historical data.