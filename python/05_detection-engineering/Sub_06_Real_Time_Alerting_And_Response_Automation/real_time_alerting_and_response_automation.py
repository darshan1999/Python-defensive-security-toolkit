...
if __name__ == "__main__":
    start_monitoring()
# - FileSystemEventHandler from `watchdog` lets you react to file writes immediately.
# - Regex-based detection is efficient for line-by-line log analysis.
# - Rate-limiting via timestamps prevents alert storms.
# - Threading offloads network calls (Slack, API) so the file watcher never blocks.