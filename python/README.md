...
**
Note for recruiters and reviewers: This folder contains my coursework and learning notes from studying blue team Python and SIEM architecture. These are annotated scripts written while working through security automation concepts — they are intentionally educational, not production tools.
